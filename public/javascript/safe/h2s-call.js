...
function login(num)
{
  ...
  x.open("GET", "http://d2dx.com/scaffold1020/proxy.php?access_token=", true);
  x.onload = function() {
    var json = JSON.parse(x.responseText);
    selfnumber.textContent = json.virtual_identifiers.mobile[0];
    gui_user.textContent = json.info.first_name;
  };
